...
class UI():         
    ...
    def stats_refresh(self,character):
        ...
        stats["STR"].text = "{:.0f}".format(character.STR)
        stats["DEX"].text = "{:.0f}".format(character.DEX)
        stats["INT"].text = "{:.0f}".format(character.INT)
        stats["defence"].text = "{:.0f}".format(character.defence)
        stats["damage"].text = "{:.0f}".format(character.damage)
