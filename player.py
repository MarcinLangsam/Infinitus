...
class Character(Widget):
    def __init__(self, **kwargs):
        ...
        self.inventory = {
            ...
            0 : [50,750,"graphics/items/zelazny_miecz.png","item"],
            1 : [150,750,"graphics/items/miecz_z_brazu.png","item"],
            2 : [250,750,"graphics/items/miecz_poltorareczny.png","item"], 
            3 : [350,750,"graphics/items/laska_maga.png","item"],
            4 : [450,750,"graphics/items/majcher_lotra.png","item"],
            5 : [50,650,"graphics/items/skorzany_pancerz.png","item"],
            6 : [150,650,"graphics/items/drewniany_puklerz.png","item"],
            7 : [250,650,"graphics/items/ksiega_czarow.png","item"],
            8 : [350,650,"graphics/items/pierscien_zdrowia.png","item"],
            9 : [450,650,"graphics/items/pierscien_many.png","item"],
            10 : [50,550,"graphics/items/szata_maga.png","item"],
            11 : [150,550,"graphics/items/zbroja_plytowa.png","item"],
            12 : [250,550,"graphics/items/kaftan_zlodzieja.png","item"],
            13 : [350,550,"graphics/items/pierscien_sily.png","item"],
            14 : [450,550,"graphics/items/pierscien_zrecznosci.png","item"],
            15 : [50,450,"graphics/items/pierscien_inteligencji.png","item"],
