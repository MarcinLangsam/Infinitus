...
class Skills():
    skill_list={
        ...
        2:["cios rękojeścią","self.final_damage = self.current_turn.STR\nself.action_status = 'ogluszenie'","zamach","graphics/skills/cios_rekojescia.png",350,270,0,"graphics/skills/cios_rekojescia_ok.png",30,"active","Ogłuszenie\nAtak obuchowy powodujący ogłuszenie\nCzas trwania: 1 tura, Pominięcie tury\nKoszt MP: 30","melee","on_enemy"],
        ...
        4:["gniew","self.final_damage = 0\nself.action_status = 'sila'","cios rękojeścią","graphics/skills/gniew.png",350,470,2,"graphics/skills/gniew_ok.png",20,"active","Gniew\nZwiększasz na chwilę swoją siłę\nCzas trawania: 3 tury, STR+20%\nKoszt MP: 20","status","on_characters"],
        ...
        8:["skupienie","self.final_damage = 0\nself.action_status = 'inteligencja'","uzdrowienie","graphics/skills/skupienie.png",700,470,7,"graphics/skills/skupienie_ok.png",20,"active","Skupienie\nZwiększa na chwilę twoją inteligencje\nCzas trwania: 3 tury, INT+20%\nKoszt MP: 20","status","on_characters"],  
        ...
        15:["rozgrzewka","self.final_damage = 0\nself.action_status = 'zrecznosc'","piorun","graphics/skills/rozgrzewka.png",1150,470,13,"graphics/skills/rozgrzewka_ok.png",30,"active","Rozgrzewka\nNa chwilę zwiększa zręczność\nCzas trwania: 3 tury, DEX+20%\nKoszt MP: 30","status","on_characters"],
