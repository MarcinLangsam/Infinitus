...
class Skills():
    skill_list={
        ...
        0:["zamach","self.final_damage = 10+self.current_turn.STR*9","none","graphics/skills/zamach.png",300,70,"none","graphics/skills/zamach_ok.png",10,"active","Zamach\nObszerny zamach zadający:\n10+STR*9 obrażeń\nKoszt MP: 10","melee","on_enemy"],
        1:["rozpłatanie","self.final_damage = self.current_target.HP*0.2","zamach","graphics/skills/rozplatanie.png",250,270,0,"graphics/skills/rozplatanie_ok.png",20,"active","Rozpłatanie\nPotężny cios zadający:\naktualne 20% zrowia przeciwnika\nKoszt MP: 20","melee","on_enemy"],
        2:["cios rękojeścią","self.current_target.status.append([se.status_effect.status_list['ogluszenie'].copy(),se.Status_Icon('graphics/icons/ogluszenie_status.png','Ogłuszenie\\nCel jest ogłuszony i pomija swoją turę'),Label(font_size = 22)])\nself.final_damage = 'OGŁUSZENIE!'","zamach","graphics/skills/cios_rekojescia.png",350,270,0,"graphics/skills/cios_rekojescia_ok.png",20,"active","Ogłuszenie\nAtak obuchowy powodujący ogłuszenie\nCzas trwania: 1 tura, Pominięcie tury\nKoszt MP: 20","status","on_enemy"],
        ...
        4:["gniew","self.current_target.status.append([se.status_effect.status_list['sila'].copy(),se.Status_Icon('graphics/icons/gniew_status.png','Gniew\\nSiła zostaje zwiększona o 10%'),Label(font_size = 22)])\nself.final_damage = 'GNIEW!'","cios rękojeścią","graphics/skills/gniew.png",350,470,2,"graphics/skills/gniew_ok.png",30,"active","Gniew\nZwiększasz na chwilę swoją siłę\nCzas trawania: 3 tury, STR+20%\nKoszt MP: 30","status","on_characters"],
        5:["ostateczny osoąd","self.final_damage = self.current_turn.STR*20","gniew","graphics/skills/ostateczny_osad.png",350,670,4,"graphics/skills/ostateczny_osad_ok.png",50,"active","Ostateczny osoąd\nCios kładący każdego na kolana zadaje:\nSTR*20\nKoszt MP: 50","melee","on_enemy"],
        
        #umiejętności maga
        6:["kula ognia","self.final_damage = 15+self.current_turn.INT*8","none","graphics/skills/kula_ognia.png",700,70,"none","graphics/skills/kula_ognia_ok.png",10,"active","Kula Ognia\nPrzemiana magi w ogień zadaje:\n15+INT*8\nKoszt MP: 10","ranged","on_enemy"],
        ...
        12:["ciche cięcie","self.final_damage = 5+self.current_turn.DEX*10","none","graphics/skills/ciche_cięcie.png",1100,70,"none","graphics/skills/ciche_cięcie_ok.png",10,"active","Ciche Cięcie\nAtak z zaskoczenia zadaje:\n5+DEX*6\nKoszt MP: 10","melee","on_enemy"],
        13:["piorun","self.final_damage = self.current_turn.INT*4 + self.current_turn.DEX*6","ciche cięcie","graphics/skills/piorun.png",1100,270,12,"graphics/skills/piorun_ok.png",15,"active","Piorun\nPołączenie magi i techniki zadaje:\nINT*4 + DEX*6\nKoszt MP: 15","ranged","on_enemy"],
