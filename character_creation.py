...
class Character_Creation(Screen):
    ...
    def setup_window(self):
        ...
        self.add_widget(Button(pos_hint={"x": 0.9, "y": 0.92}, size=(160,60), font_size= 20, text="Wróc do menu", outline_width=1, size_hint=(None,None), background_normal="graphics/text_box.png", background_down="graphics/text_box_dark.png", on_press = lambda y:self.change_screen("main_menu")))
        self.add_widget(Button(pos_hint={"center_x": 0.5, "center_y": 0.1}, size=(500,70), font_size= 40, text="Rozpocznij Grę!", outline_width=1, size_hint=(None,None), background_normal="graphics/text_box.png", background_down="graphics/text_box_dark.png", on_press = lambda y:self.change_screen("menu")))
