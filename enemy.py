...
enemy_skills ={
    ...
    "obezwladnienie":["Obezwładnienie","self.current_target.status.append([se.status_effect.status_list['obezwladienie'].copy(),se.Status_Icon('graphics/icons/ogluszenie_status.png','Obezwładnienie\\nCel pomija swoją turę'),Label(font_size = 22)])\nself.final_damage = 'OBEZWŁADNIENIE!'","by_status","obezwladnienie","on_character","status"],
...
skeleton = Enemy("Szkielet",1,50,20,10,10,5,0,50,10,{"atak":enemy_skills["atak"],"zatrucie":enemy_skills["zatrucie"]},{"graphics/items/pierscien_sily.png":50},"graphics/items/skeleton.png")
skeleton2 = Enemy("Szkielet",1,50,10,10,10,5,0,50,10,{"atak":enemy_skills["atak"],"zatrucie":enemy_skills["zatrucie"]},{"graphics/items/pierscien_sily.png":50},"graphics/items/skeleton.png")
skeleton3 = Enemy("Szkielet",1,50,10,10,10,5,0,50,10,{"atak":enemy_skills["atak"],"zatrucie":enemy_skills["zatrucie"]},{"graphics/items/pierscien_sily.png":50},"graphics/items/skeleton.png")
