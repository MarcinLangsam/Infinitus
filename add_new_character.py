...
class Add_New_Character(Screen):
    ...
    def setup_window(self):
        ...
        self.add_widget(Button(pos_hint={"center_x": 0.5, "center_y": 0.1}, size=(500,70), font_size= 40, text="Dalej!", outline_width=1, size_hint=(None,None), background_normal="graphics/text_box.png", background_down="graphics/text_box_dark.png", on_release = lambda y:self.change_screen("menu")))
