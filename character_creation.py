...
class Character_Creation(Screen):
    ...
    def setup_window(self):
        ...
        self.add_widget(Button(pos_hint={"x": 0.9, "y": 0.92}, size=(160,60), font_size= 20, text="Wróc do menu", outline_width=1, size_hint=(None,None), background_normal="graphics/text_box.png", background_down="graphics/text_box_dark.png", on_release = lambda y:self.change_screen("main_menu")))
